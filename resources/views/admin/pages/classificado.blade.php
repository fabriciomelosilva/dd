		...
		<div class="row">
			<div class="col-12">
				<div class="page-title-box">
					<h4 class="page-title">Novo Classificados</h4>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
				<div class="card">
					<div class="card-body">
						...
						<form class="form-horizontal" id="formulario" action="classificado" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
							<div class="form-group row">
								<div class="col-sm-10 offset-sm-1">
									<label class="col-sm-12 col-form-label">Data</label>
									<input required class="form-control" name="data_classificado" type="text" id="calendario" autocomplete="off"/>
								</div>
							</div>
